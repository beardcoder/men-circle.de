...
<x-twill::input name="name" :label="__('messages.name')" />

<x-twill::wysiwyg name="text" :label="__('messages.text')" />

<x-twill::medias name="cover" :label="__('messages.cover')" field-note="Minimum image width: 1500px" />
